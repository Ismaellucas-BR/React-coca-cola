...
export default function SectionFloatContent(props: PropsSectionFloatContent) {
  return (
    <section
      className={`flex  xl:max-w-[70rem]  lg:px-0  lg:pt-10 lg:pb-20 lg:items-center lg:justify-center xl:mt-30 ${props.extraClassSection} w-[90%] `}>
      <img
        src={props.urlImage}
        alt={props.alt}
      ...
      />
      <div
        className={`px-8 relative -bottom-10 z-10 xl:w-1/2  lg:p-0 xl:-mr-14 lg:max-w-[90%] ${props.extraClassDiv} flex flex-col rounded-lg shadow-lg p-6 gap-2 z-20 bg-white h-full lg:items-left lg:justify-between lg:p-14  xl:min-h-[34.5rem] xl:-mt-70`}>
